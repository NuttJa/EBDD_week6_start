...
include("../config.php");
        ...
        $image_data = "" ;     
                ...
                $sql = "INSERT INTO `inventory`(`item_no`, `item_name`, `price`, `location`,
                `qty_on_hand`, `reorder_pt`,sup_no,image_name,image_type,image_data) 
                        VALUES ('$item_no','$item_name','$price ','$location',
                        '$qty_on_hand','$reorder_pt','$sup_no','$image_name','$image_type','$image_data')";
